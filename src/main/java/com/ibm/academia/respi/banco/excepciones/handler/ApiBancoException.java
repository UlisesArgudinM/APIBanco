package com.ibm.academia.respi.banco.excepciones.handler;
...
import com.ibm.academia.respi.banco.excepciones.BadRequestException;
import com.ibm.academia.respi.banco.excepciones.NotFoundException;

@ControllerAdvice
public class ApiBancoException 
{
